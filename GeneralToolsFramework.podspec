...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GeneralToolsFramework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Zandor Smith/GeneralToolsFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Zandor Smith' => 'info@zsinfo.nl' }
  s.source           = { :git => 'https://github.com/Zandor Smith/GeneralToolsFramework.git', :tag => s.version.to_s }
